function [Whole_DVH, PrescribedDose, Structure_Name,Volume,Dose_Cover,Sampling_Cover,...
    ...
    V5_Set, V10_Set, V20_Set, V30_Set, V45_Set, V50_Set, V55_Set, V66_Set, V95_Set, V100_Set] = read_DVH_Eclipse_TPS_201027_Absolute(filename, totalDose_, hfigure_, marker_, type_)
...
%     i= (3*Index)-3;
    xxx = Whole_DVH(:,Index*2-1);    
    yyy = Whole_DVH(:,Index*2);
    xxx_absolute = xxx;
...
%     figure, plot(xxx_absolute, yyy)
    ...
    V95 = fitresult(totalDose_.*0.95);
    V100 = fitresult(totalDose_.*1.0);
